...
//Ventajas de .NET Core sobre .NET Framework:

//Multiplataforma: .NET Core funciona en diferentes sistemas operativos como Windows, Linux y macOS, mientras que .NET Framework solo se ejecuta en Windows.

//Rendimiento mejorado: .NET Core tiene un rendimiento más eficiente, optimizado para aplicaciones modernas, lo que lo hace más rápido en muchas situaciones.

//Actualizaciones más rápidas: .NET Core recibe actualizaciones y mejoras de forma más frecuente, lo que permite aprovechar nuevas tecnologías de manera más ágil.


//Desventajas de .NET Core frente a .NET Framework:
//Soporte limitado para bibliotecas antiguas: No todas las bibliotecas que funcionan en .NET Framework están disponibles en .NET Core, lo que puede limitar su uso en proyectos que dependen de tecnologías más viejas.

//Menos herramientas integradas: Algunas herramientas y características que están completamente integradas en .NET Framework no están tan maduras o disponibles en .NET Core.

//Curva de aprendizaje: Para quienes están acostumbrados a trabajar con .NET Framework, cambiar a .NET Core puede implicar un tiempo de adaptación y aprendizaje de nuevas formas de hacer las cosas.
// ************************************************************************


namespace informe00_CarlosV_BryanL
{
 class Program
 {
 /// <summary>
